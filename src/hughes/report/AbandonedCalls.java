...
public final class AbandonedCalls extends Report 
{
	...
	{
		return "Calls unable to be delivered to customers.";
	}
	 ...
	 */
	public AbandonedCalls() throws ReportSetupException
	{
		super();
	}
	...
	protected boolean setupReport() 
	{
		...
		try
		{			
			reportName = AbandonedCalls.uiGetReportName();
			reportDesc = AbandonedCalls.uiGetReportDesc();
